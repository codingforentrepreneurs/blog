---
title: Raspberry Pi Network Server Guide with Django &amp; SSH
slug: raspberry-pi-network-server-guide-with-django-ssh

publish_timestamp: Feb. 22, 2018
url: https://www.codingforentrepreneurs.com/blog/raspberry-pi-network-server-guide-with-django-ssh/
...
Adapted from [official docs](https://www.raspberrypi.org/learning/software-guide/quickstart/) and moved from our [github](http://joincfe.com/github).

Formatting the SD Card is designed for Mac systems but similar steps can be taken on Windows/Linux (please leave comment if you find a solid way).
...
[Raspbian Stretch with Desktop](https://www.raspberrypi.org/downloads/raspbian/): A Raspberry Pi Linux/Debian Operating system. [Docs](https://www.raspbian.org/)

### Setup the Pi

1. Flash microSD card 
    1. Download [SDFormatter](https://www.sdcard.org/downloads/formatter_4/) for your System version.
...
This step most likely will require you to connect your pi to a monitor, keyboard, and mouse. I recommend using a USB keyboard/mouse and a HDMI monitor.
